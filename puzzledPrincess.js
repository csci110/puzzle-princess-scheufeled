    ...
    takeTurns() {
        if (this.gameIsWon()) {
            ...
            if (this.activeMarker instanceof PrincessMarker) {
                message = message + 'The Princess Has Out Smarted The Poor Sap.';
            }
            else if (this.activeMarker instanceof StrangerMarker) {
                message = message + 'The Stranger Wins And Sneaks Off Into The Darkness.';
            }
            game.end(message);
            return;
        }
        if (this.gameIsDrawn()) {
            game.end('        Game Over.\n        The game ends in a draw you both our terrible.');
            return;
        }
